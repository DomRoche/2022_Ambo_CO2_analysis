...
# activity
activity_all <- rpt(sqrt(activity) ~  1 + trial + (1|fishID), grname = "fishID", 
                    data = dat, datatype = "Gaussian", 
                    nboot = 10000, npermut = 10000)


activity_con <- rpt(sqrt(activity) ~  1 + trial + (1|fishID), grname = "fishID", 
                    data = subset(dat, group == "control"), datatype = "Gaussian", 
                    nboot = 10000, npermut = 10000)

activity_co2 <- rpt(sqrt(activity) ~  1 + trial +  (1|fishID), grname = "fishID", 
...
#shelter
shelter_all <- rpt(shelter ~  1 + trial +  (1|fishID), grname = "fishID", 
                   data = dat, datatype = "Gaussian", 
                   nboot = 10000, npermut = 10000)

shelter_con <- rpt(shelter ~  1 + trial +  (1|fishID), grname = "fishID", 
                   data = subset(dat, group == "control"), datatype = "Gaussian", 
                   nboot = 10000, npermut = 10000)

shelter_co2 <- rpt(shelter ~  1 + trial +  (1|fishID), grname = "fishID", 
                   data = subset(dat, group == "CO2"), datatype = "Gaussian", 
                   nboot = 10000, npermut = 10000)
...
#thigmotaxis
thigmotaxis_all <- rpt(sqrt(thigmotaxis) ~  1 + trial +  (1|fishID), grname = "fishID", 
                       data = dat, datatype = "Gaussian", 
                       nboot = 10000, npermut = 10000)

thigmotaxis_con <- rpt(sqrt(thigmotaxis) ~  1 + trial +  (1|fishID), grname = "fishID", 
                       data = subset(dat, group == "control"), datatype = "Gaussian", 
                       nboot = 10000, npermut = 10000)

thigmotaxis_co2 <- rpt(sqrt(thigmotaxis) ~  1 + trial +  (1|fishID), grname = "fishID", 
                       data = subset(dat, group == "CO2"), datatype = "Gaussian", 
                       nboot = 10000, npermut = 10000)
...
#novel
novel_all <- rpt(log(novel+0.5) ~  1 + trial +  (1|fishID), grname = "fishID", 
                 data = dat, datatype = "Gaussian", 
                 nboot = 10000, npermut = 10000)

novel_con <- rpt(log(novel+0.5) ~  1 + trial +  (1|fishID), grname = "fishID", 
                 data = subset(dat, group == "control"), datatype = "Gaussian", 
                 nboot = 10000, npermut = 10000)

novel_co2 <- rpt(log(novel+0.5) ~  1 + trial +  (1|fishID), grname = "fishID", 
                 data = subset(dat, group == "CO2"), datatype = "Gaussian", 
                 nboot = 10000, npermut = 10000)
...
# emergT
emergT_all <- rpt(log(emergT) ~  1 + trial +  (1|fishID), grname = "fishID", 
                  data = dat, datatype = "Gaussian", 
                  nboot = 10000, npermut = 10000)

emergT_con <- rpt(log(emergT) ~  1 + trial + (1|fishID), grname = "fishID", 
                  data = subset(dat, group == "control"), datatype = "Gaussian", 
                  nboot = 10000, npermut = 10000)

emergT_co2 <- rpt(log(emergT) ~  1 + trial + (1|fishID), grname = "fishID", 
                  data = subset(dat, group == "CO2"), datatype = "Gaussian", 
                  nboot = 10000, npermut = 10000)

comp_rpt(emergT_co2, emergT_con)

save(activity_all, activity_co2, activity_con, 
          shelter_all,shelter_co2, shelter_con,
          thigmotaxis_all, thigmotaxis_co2, thigmotaxis_con, 
          novel_all, novel_co2, novel_con,
          emergT_all, emergT_co2, emergT_con, file = here("Dom_analysis","repeatability.RData")
     )#load("repeatability.Rdata")